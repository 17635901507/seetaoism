...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) BaseApp.getBaseApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int sp2px(float spValue) {
        float scaledDensity = BaseApp. getBaseApp().getResources().getDisplayMetrics().scaledDensity;
